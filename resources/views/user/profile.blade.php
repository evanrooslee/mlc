    ...
    <div class="relative">
        ...
        <div class="flex items-center mb-8">
            ...
            <div>
                ...
                <button data-modal-target="edit-modal" data-modal-toggle="edit-modal"
                    class="mt-4 bg-[#01a8dc] text-white font-bold py-2 px-4 rounded-full inline-flex items-center shadow-md hover:bg-[#0195c9] transition-colors">
                    <span>Edit</span>
        ...
        <div class="bg-white p-8 rounded-lg shadow-lg">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <div class="mt-1 p-3 bg-gray-100 rounded-lg text-gray-700">{{ Auth::user()->name }}</div>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-500">Email Aktif</label>
                            <div class="mt-1 p-3 bg-gray-100 rounded-lg text-gray-700">{{ Auth::user()->email }}</div>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-500">No HP Siswa</label>
                            <div class="mt-1 p-3 bg-gray-100 rounded-lg text-gray-700">
                        ...
                        <div>
                            ...
                            <div class="mt-1 p-3 bg-gray-100 rounded-lg text-gray-700">Kelas
                ...
                <div>
                    <h2 class="text-2xl font-bold text-gray-800 mb-6">Kelas Populer</h2>
                        ...
                        @if ($popularPackets->count() > 0)
                            ...
                            <div class="bg-[#ECECEC] rounded-lg p-6">
                                <div id="packet-display" class="packet-card bg-white overflow-hidden">
                                    <div class="aspect-video w-full overflow-hidden relative">
                                        ...
                                        <img id="packet-image"
                                            ...
                                            height="225" onerror="handleImageError(this)"
                                ...
                                <div class="flex items-center justify-center mt-6">
                                    <a id="detail-btn"
                                        href="{{ route('beli-paket.show', $popularPackets->first()->id) }}"
                                        class="detail-button text-white font-bold py-2 px-6 rounded-full">
                                        Lihat Detail
                                    </a>
                                </div>
                            </div>
                            ...
                            @if ($popularPackets->count() > 1)
                                <div class="pagination-controls">
                                    <button id="prev-btn" class="nav-btn text-gray-400" disabled
                                        aria-label="Previous packet">
                                        ←
                                    </button>
                                    <button id="next-btn" class="nav-btn text-[#01A8DC]" aria-label="Next packet">
                                        →
                                    </button>
                                </div>
                                                    ...
                                                    <div class="packet-card bg-white overflow-hidden">
                                                        <div class="aspect-video w-full overflow-hidden">
                                                            <img src="{{ $packet->image_url }}"
                                                                ...
                                                                class="packet-image w-full h-full object-cover"

        ...
        <form wire:submit.prevent="save">
            ...
            <div class="space-y-4 sm:space-y-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                    ...
                    <div>
                        <label for="tingkatan" class="block text-sm font-medium text-gray-700 mb-2">Jenjang Pendidikan
                            <span class="text-red-500" aria-label="wajib diisi">*</span></label>
                        <select id="tingkatan" wire:model.live="tingkatan"
                            ...
                            @error('tingkatan') aria-describedby="tingkatan-error" @enderror>
                        ...
                        @error('tingkatan')
                            <span id="tingkatan-error" class="text-red-500 text-sm mt-1 flex items-center"
                                role="alert">
                                <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
                                    <path fill-rule="evenodd"
                                        d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z"
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                    <!-- Kurikulum Field -->
                    <div>
                        <label for="kurikulum" class="block text-sm font-medium text-gray-700 mb-2">Kurikulum <span
                                class="text-red-500" aria-label="wajib diisi">*</span></label>
                        <select id="kurikulum" wire:model.live="kurikulum" @disabled($isKurikulumDisabled)
                            ...
                            @error('kurikulum') aria-describedby="kurikulum-error" @enderror>
                            <option value="">Pilih Kurikulum</option>
                            @if ($isOlimpiade)
                                <option value="SMP">SMP (Olimpiade)</option>
                                <option value="SMA">SMA (Olimpiade)</option>
                            @else
                        ...
                        @error('kurikulum')
                            <span id="kurikulum-error" class="text-red-500 text-sm mt-1 flex items-center"
                                role="alert">
                                <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
                                    <path fill-rule="evenodd"
                                        d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z"
                    ...
                    <div>
                        <label for="grade" class="block text-sm font-medium text-gray-700 mb-2">Kelas <span
                                class="text-red-500" aria-label="wajib diisi">*</span></label>
                        <select id="grade" wire:model.live="grade" @disabled($isGradeDisabled)
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                    <!-- Subject Field -->
                    <div>
                        <label for="subject" class="block text-sm font-medium text-gray-700 mb-2">Mata Pelajaran
                            <span class="text-red-500" aria-label="wajib diisi">*</span></label>
                ...
                <div class="grid grid-cols-1 gap-4 sm:gap-6">
                    ...
                    <div>
                        <div class="flex items-center mb-3">
                            ...
                            <label for="has_discount" class="ml-2 text-sm font-medium text-gray-700">Tambahkan
                                Diskon</label>
                        </div>
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="relative">
                                    ...
                                    @error('selected_discount_id')
                                        <span id="discount-error" class="text-red-500 text-sm mt-1 flex items-center"
                                            role="alert">
                    ...
                    <div class="border-2 border-dashed border-gray-300 rounded-lg p-4 sm:p-8 text-center bg-gray-50">
                        ...
                        @else
                            <div class="flex flex-col items-center">
                                ...
                                <p id="image-help" class="text-xs text-gray-500 mt-2">Format: JPG, PNG, GIF (Max: 2MB)
                                </p>
                                <p class="text-xs text-gray-400 mt-1">Jika tidak dipilih, akan menggunakan gambar
                                    default</p>
                            </div>
                        @endif

    ...
    @if ($showDeleteConfirmation)
        <div class="fixed inset-0 bg-gray-500 bg-opacity-75 flex items-center justify-center z-50">
            <div class="bg-white rounded-lg p-6 max-w-sm mx-auto">
                ...
                <h3 class="text-lg font-medium text-gray-900 mb-2 text-center">Konfirmasi Hapus</h3>
                <p class="text-gray-600 mb-6 text-center">Apakah Anda yakin ingin menghapus paket "{{ $title }}"?
                    Tindakan ini tidak dapat dibatalkan.</p>
                <div class="flex justify-center space-x-3">
                    <button type="button" wire:click="cancelDelete" wire:loading.attr="disabled" wire:target="delete"
                        class="px-4 py-2 bg-white border border-gray-300 text-gray-700 rounded-md hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed">
                        Batal
                    </button>
                    <button type="button" wire:click="delete" wire:loading.attr="disabled" wire:target="delete"
                        class="px-4 py-2 bg-red-600 text-white rounded-md hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed">
        ...
        <form wire:submit.prevent="update">
            <div class="space-y-4 sm:space-y-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                    <!-- Judul Paket Field -->
                    <div>
                        <label for="edit-title" class="block text-sm font-medium text-gray-700 mb-2">Judul Paket <span
                        ...
                        @error('title')
                            <span id="edit-title-error" class="text-red-500 text-sm mt-1 flex items-center"
                                role="alert">
                    ...
                    <!-- Harga Field -->
                    <div>
                        <label for="edit-price" class="block text-sm font-medium text-gray-700 mb-2">Harga <span
                                class="text-red-500" aria-label="wajib diisi">*</span></label>
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                <span class="text-gray-500 text-sm">Rp</span>
                            </div>
                            <input type="number" id="edit-price" wire:model.live="price"
                                ...
                                @error('price') aria-describedby="edit-price-error" @enderror>
                        </div>
                        @error('price')
                            <span id="edit-price-error" class="text-red-500 text-sm mt-1 flex items-center"
                                role="alert">
                                <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
                                    <path fill-rule="evenodd"
                                        d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z"
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                    <!-- Kode Paket Field -->
                    <div>
                        <label for="edit-code" class="block text-sm font-medium text-gray-700 mb-2">Kode Paket <span
                                class="text-red-500" aria-label="wajib diisi">*</span></label>
                        <input type="text" id="edit-code" wire:model.live="code"
                            ...
                            @error('code') aria-describedby="edit-code-error" @enderror>
                        @error('code')
                            <span id="edit-code-error" class="text-red-500 text-sm mt-1 flex items-center"
                                role="alert">
                                <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
                                    <path fill-rule="evenodd"
                                        d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z"
                    ...
                    <div>
                        ...
                        <div x-show="$wire.has_discount" x-transition>
                            <div class="space-y-4">
                                <!-- Pilih Diskon Field -->
                                <div class="relative">
                                    <label for="edit-discount_search"
                ...
                <div>
                    ...
                    <div class="border-2 border-dashed border-gray-300 rounded-lg p-4 sm:p-8 text-center bg-gray-50">
                        ...
                        <input type="file" wire:model="image" accept="image/*" class="hidden"
                            id="edit-image-upload" aria-describedby="edit-image-help">
                    </div>
                    @error('image')
            ...
            <div class="flex justify-between mt-8">
                <button type="button" wire:click="confirmDelete" wire:loading.attr="disabled" wire:target="update"
                    class="px-6 py-3 bg-red-600 text-white rounded-md hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 font-medium disabled:opacity-50 disabled:cursor-not-allowed transition-opacity duration-200">
                    🗑️ Hapus Paket
                </button>

                <button type="submit" wire:loading.attr="disabled" wire:target="update"
                    class="px-8 py-3 bg-green-600 text-white rounded-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 font-medium disabled:opacity-50 disabled:cursor-not-allowed transition-opacity duration-200">

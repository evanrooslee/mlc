...
<body class="flex flex-col md:flex-row font-quicksand min-h-screen">
    <div class="hidden md:flex bg-[#ffffff] w-[184px] flex-shrink-0 border-r border-[#c9c9c9] flex-col items-center pt-4 min-h-screen sticky top-0">

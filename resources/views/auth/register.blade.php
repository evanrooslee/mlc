...
@section('content')
    <div class="min-h-screen flex items-center justify-center bg-gray-50 mt-4">
        <div class="w-full max-w-md">
            ...
            <div class="bg-white p-8 rounded-lg shadow-md">
                <h2 class="text-2xl font-bold text-center mb-8">Buat Akun</h2>
                ...
                <form method="POST" action="{{ route('register.store') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="parents_phone_number" id="parents_phone_number"
                            ...
                            class="w-full px-3 py-2 border border-gray-300 rounded-md @error('parents_phone_number') border-red-500 @enderror"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="school" id="school" placeholder="Masukkan nama sekolah"
                            class="w-full px-3 py-2 border border-gray-300 rounded-md @error('school') border-red-500 @enderror"
                    ...
                    <div class="mb-4">
                        ...
                        <select name="grade" id="grade"
                            class="w-full px-3 py-2 border border-gray-300 rounded-md @error('grade') border-red-500 @enderror"
                            required>

...
DROP TABLE IF EXISTS `banner_cards`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `banner_cards` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_active_display_order` (`display_order`,`is_active`),
  KEY `banner_cards_is_active_index` (`is_active`),
  KEY `banner_cards_display_order_index` (`display_order`),
  KEY `banner_cards_is_active_display_order_index` (`is_active`,`display_order`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (18,'2025_08_19_145230_create_banner_cards_table',2);

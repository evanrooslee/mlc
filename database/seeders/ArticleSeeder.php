...
class ArticleSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $articles = [
            [
                'title' => '[DUMMY] Kecerdasan Buatan: Teman atau Ancaman di Era Digital?',
                'source' => 'kompas.com',
                'url' => 'https://www.kompas.com/skola/read/2023/04/13/130000169/kecerdasan-buatan--teman-atau-ancaman-di-era-digital-',
                'image' => 'https://via.placeholder.com/400x300/6366F1/FFFFFF?text=DUMMY+ARTICLE+1',
                'is_starred' => false,
            ],
            [
                'title' => '[DUMMY] 5 Manfaat Bimbel Bagi Anak, Mulai dari Meningkatkan Minat Belajar hingga Mengasah Kecerdasan',
                'source' => 'kompas.com',
                ...
                'image' => 'https://via.placeholder.com/400x300/6366F1/FFFFFF?text=DUMMY+ARTICLE+2',
                'is_starred' => false,
            ],
            [
                'title' => '[DUMMY] Strategi Belajar Efektif: Kunci Sukses Meraih Prestasi di Era Digital',
                'source' => 'kompas.com',
                'url' => 'https://www.kompas.id/baca/humaniora/2023/08/11/strategi-belajar-efektif-kunci-sukses-meraih-prestasi-di-era-digital',
                'image' => 'https://via.placeholder.com/400x300/6366F1/FFFFFF?text=DUMMY+ARTICLE+3',
                'is_starred' => false,
            ],
        ];
